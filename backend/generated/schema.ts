...
export interface paths {
    ...
    "/cache/fetch": {
        ...
        get: {
            ...
            requestBody?: never;
            responses: {
                /** @description Success. Will return the cached file from the file system. */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/user/details": {
        ...
        /** @description Get the details of the specified user */
        get: {
            parameters: {
                query: {
                    uid: string;
...
export interface components {
    schemas: {
        ...
        /** @description User preferences that can be changed in the UI */
        UserPreferences: {
            timezone: string;
        };
        User: {
             ...
             * @example ckx1234567890abcdef123456
             */
            id: string;
            /**
             * Format: email
